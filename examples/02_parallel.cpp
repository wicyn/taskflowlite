...
int main() {
    std::osyncstream(std::cout) << "=== Example 02: Parallel Tasks ===\n";
    ...
    std::osyncstream(std::cout) << "Executed " << counter.load() << " parallel tasks\n";
    return 0;
}
